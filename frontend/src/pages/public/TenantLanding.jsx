...
const DEFAULT_SECTION_ORDER = ['header', 'banner', 'about', 'hours', 'social', 'sociallinks', 'quicklinks', 'services', 'reviews', 'policies'];
...
function SocialLinksSection({ siteSettings }) {
  const links = [
  ...
  const activeLinks = links.filter(l => siteSettings[l.key]);
        ...
        {activeLinks.map(({ key, label, icon, color }) => (
          <Box
            ...
            sx={{
              ...
              '&:hover': { transform: 'translateY(-2px)', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', borderColor: color },
            }}
          >
...
export default function TenantLanding() {
  ...
  const SECTION_COMPONENTS = {
    ...
    sociallinks: <SocialLinksSection siteSettings={siteSettings} />,
